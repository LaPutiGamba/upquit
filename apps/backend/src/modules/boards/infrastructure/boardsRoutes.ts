...
// Protected
boardsRouter.post("/", JwtAuthMiddleware, CreateBoardPostController);
boardsRouter.patch("/:id", JwtAuthMiddleware, UpdateBoardPatchController);
boardsRouter.post("/:id/categories", JwtAuthMiddleware, AddBoardCategoryPostController);
boardsRouter.post("/:id/members", JwtAuthMiddleware, AddBoardMemberPostController);
